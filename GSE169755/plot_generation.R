...
with(subset(res, padj < padjthr & log2FoldChange > 2), points(log2FoldChange, -log10(pvalue), pch=20, col="red2"))
with(subset(res, padj < padjthr & log2FoldChange > 4), points(log2FoldChange, -log10(pvalue), pch=20, col="red4"))
...
with(subset(res, padj < padjthr & log2FoldChange < -2), points(log2FoldChange, -log10(pvalue), pch=20, col="blue2"))
with(subset(res, padj < padjthr & log2FoldChange < -4), points(log2FoldChange, -log10(pvalue), pch=20, col="blue4"))

# Counts
## sum(!is.na(res$padj) & res$padj < padjthr & !is.na(res$log2FoldChange) & res$log2FoldChange > 2, na.rm = TRUE)
